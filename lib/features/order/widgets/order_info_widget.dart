...
class OrderInfoWidget extends StatelessWidget {
  ...
  const OrderInfoWidget(
      {Key? key, required this.orderModel, required this.timeSlot})
      : super(key: key);
    ...
    return Consumer<OrderProvider>(builder: (context, orderProvider, _) {
      ...
      return Column(
        ...
        children: [
                      ...
                      child: Column(
                        ...
                        Row(children: [
                          Row(children: [
                            ...
                            Text(orderProvider.trackModel!.id.toString(),
                        ...
                        timeSlot != null
                            ...
                            : const SizedBox(),
                        SizedBox(
                            height: timeSlot != null
                                ? Dimensions.paddingSizeSmall
                                : 0),
                        if (orderProvider.trackModel?.deliveryDate != null)
                          Padding(
                            padding: const EdgeInsets.only(
                                bottom: Dimensions.paddingSizeSmall),
                            child: Row(children: [
                              Text(
                                  '${getTranslated('estimate_delivery_date', context)}: ',
                                  style: poppinsRegular),
                              const SizedBox(
                                  width: Dimensions.paddingSizeExtraSmall),
                              Text(
                          ...
                          if (orderProvider.trackModel?.deliveryDate != null)
                            Padding(
                              ...
                              child: Row(children: [
                                ...
                                Text(
                                    DateConverterHelper
                                        .isoStringToLocalDateOnly(orderProvider
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            getTranslated(
                                orderProvider.trackModel!.orderStatus, context),
                            style: poppinsRegular.copyWith(
                                color: OrderStatus.pending.name ==
                                        orderProvider.trackModel!.orderStatus
                                    ? ColorResources.colorBlue
                        ...
                        if (orderProvider.trackModel!.orderType == 'delivery')
                          InkWell(
                            onTap: () {
                              if (orderProvider.trackModel!.deliveryAddress !=
                                  null) {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (_) => OrderMapInfoWidget(
                                            address: orderProvider
                                                .trackModel!.deliveryAddress)));
                              } else {
                                showCustomSnackBarHelper(
                                    getTranslated('address_not_found', context),
                                    isError: true);
                              }
                            },
                            child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  Text(
                    getTranslated(
                        orderProvider.trackModel!.paymentStatus, context),
                    style: poppinsMedium,
                  ),
                ]),
                ...
                Row(children: [
                  ...
                  Row(children: [
                    (orderProvider.trackModel!.paymentMethod != null &&
                                orderProvider
                    ...
                    if (orderProvider.trackModel?.paymentStatus ==
                        'partially_paid')
                      Text(' + ${getTranslated('wallet', context)}',
                          style: poppinsMedium),
                    if (orderProvider.trackModel?.paymentMethod ==
                            'offline_payment' &&
                        ResponsiveHelper.isDesktop(context))
          ...
          OrderedProductListWidget(isActive: false),

          //  new addedd code
          // OrderedProductListWidget(isActive: true),
          ...
          (orderProvider.trackModel?.orderNote?.isNotEmpty ?? false)
              ? Container(
                  padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                  ...
                  child: Text(orderProvider.trackModel?.orderNote ?? '',
                      style: poppinsRegular.copyWith(
                        color: Theme.of(context)
                            .textTheme
                            .bodyLarge
          ...
          if (orderProvider.trackModel?.orderImageList?.isNotEmpty ?? false)
            Container(
              padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),
                      ...
                      children: [
                        CustomSingleChildListWidget(
                          ...
                          itemCount: orderProvider
                                  .trackModel?.orderImageList?.length ??
                              0,
                          itemBuilder: (index) {
                            return InkWell(
                              onTap: () {
                                      ...
                                      builder: (ctx) => CustomAlertDialogWidget(
                                            ...
                                            child: CustomZoomWidget(
                                              image: CustomImageWidget(
                                                  ...
                                                  height: 400,
                                                  image:
                                                      '${splashProvider.configModel?.baseUrls?.orderImageUrl}/${orderProvider.trackModel?.orderImageList?[index].image}'),
                                            ),
                                          )));
                                } else {
                                  Navigator.of(context).pushNamed(
                                    RouteHelper.getProductImagesRoute(
                                      ...
                                      jsonEncode([
                                        orderProvider
                                                .trackModel
                                                ?.orderImageList?[index]
                                                .image ??
                                            ''
                                      ]),
                                      splashProvider.configModel?.baseUrls
                                              ?.orderImageUrl ??
                                          '',
                                    ),
                                  );
