...
class AppConstants {
  ...
  static const String baseUrl = 'https://Development.mangao.in';
  ...
  static const String levelListUri = '/api/v1/referralIncomeList';
  ...
  static const String ordereditSubmitUri = '/api/v1/customer/order/editsubmit';
  static const String trackUri = '/api/v1/customer/order/track';
  // static const String edi = '/api/v1/customer/order/editpayment';
